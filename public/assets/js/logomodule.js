...
const tabsData = [
  { href: "search", icon: "fas fa-search", label: "🎵 음악 검색" },
  { href: "chart", icon: "fas fa-chart-line", label: "📊 음악 차트" },
  { href: "playlist", icon: "fas fa-music", label: "🎧 플레이리스트" },
  { href: "artist", icon: "fas fa-user", label: "🧑‍🎤 아티스트 분석" },
  { href: "recommend", icon: "fas fa-star", label: "🎲 추천" },
];
